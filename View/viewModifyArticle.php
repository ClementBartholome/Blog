...
<form action="index.php?action=modify_article" method="post" class="add-article-form">
    ...
    <input type="text" id="title" name="title" class="title-editor" value="<?= htmlspecialchars($article->getTitle()) ?>"><br>
    ...
    <div class="editor-container">
        ...
        <textarea id="content" name="content" class="editor"><?= htmlspecialchars($article->getContent()) ?></textarea>
    </div>
